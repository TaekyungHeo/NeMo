...
srun --ntasks=1 --mpi=pmix --container-image=${CTRIMG} --container-name=nemo_container --container-mounts=/mswg2/E2E/theo/nemo-cb:/workspace --container-writable \
bash -c 'cp /workspace/callbacks/*.py /opt/NeMo/nemo/lightning/pytorch/callbacks/ && cd /opt/NeMo && pip install .'

srun --mpi=pmix --ntasks=8 --container-name=nemo_container --container-mounts=/mswg2/E2E/theo/nemo-cb:/workspace \
